...
`TypeScript` `React` `Next.js` `Node.js` `Java` `MySQL` `Docker` `Git`

## 🚀 Featured Projects

| 项目 | 简介 | 技术栈 |
|------|------|--------|
| [**GitHub-ZH-Plugin**](https://github.com/b8nw27v7wp-bit/GitHub-ZH-Plugin) | GitHub 界面中文化油猴脚本 — 29 种页面类型、1080+ 词条、正则动态翻译、66 项测试 | JavaScript · Tampermonkey |
